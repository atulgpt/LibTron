...
public inline fun IntentExtra.Bundle(name: String? = null, customPrefix: String? = null): PropertyDelegate<Intent, Bundle?> =
        Bundle({ it }, { it }, name, customPrefix)

public inline fun IntentExtra.Bundle(defaultValue: Bundle, name: String? = null, customPrefix: String? = null): PropertyDelegate<Intent, Bundle> =
        Bundle({ it ?: defaultValue }, { it }, name, customPrefix)

public inline fun IntentExtra.CharSequence(name: String? = null, customPrefix: String? = null): PropertyDelegate<Intent, CharSequence?> =
        CharSequence({ it }, { it }, name, customPrefix)

public inline fun IntentExtra.CharSequence(defaultValue: CharSequence, name: String? = null, customPrefix: String? = null): PropertyDelegate<Intent, CharSequence> =
        CharSequence({ it ?: defaultValue }, { it }, name, customPrefix)

public inline fun IntentExtra.String(name: String? = null, customPrefix: String? = null): PropertyDelegate<Intent, String?> =
        String({ it }, { it }, name, customPrefix)

public inline fun IntentExtra.String(defaultValue: String, name: String? = null, customPrefix: String? = null): PropertyDelegate<Intent, String> =
        String({ it ?: defaultValue }, { it }, name, customPrefix)

public inline fun <T : Parcelable>
        IntentExtra.Parcelable(name: String? = null, customPrefix: String? = null): PropertyDelegate<Intent, T?> =
