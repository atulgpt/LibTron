...
public inline fun BundleExtra.CharSequenceArrayList(
    name: String? = null,
    customPrefix: String? = null
): PropertyDelegate<Bundle, ArrayList<CharSequence?>?> =
...
public inline fun BundleExtra.StringArrayList(
    name: String? = null,
    customPrefix: String? = null
): PropertyDelegate<Bundle, ArrayList<String?>?> =
...
public inline fun BundleExtra.IntArrayList(
    name: String? = null,
    customPrefix: String? = null
): PropertyDelegate<Bundle, ArrayList<Int?>?> =
