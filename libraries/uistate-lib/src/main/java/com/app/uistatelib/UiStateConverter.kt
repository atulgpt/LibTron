...
public fun Throwable?.isNetworkError(): Boolean =
    this is java.net.SocketTimeoutException || this is UnknownHostException || this is SocketException || this is SSLException